...
This repository contains a static portfolio site. The included `deploy_user_site.sh` script will create a user-site repository named `karthikbalakumaran.github.io` under the GitHub account `KarthikBalakumaran` and push the current contents so the site is served at:

  https://karthikbalakumaran.github.io
...
- Creates `KarthikBalakumaran/karthikbalakumaran.github.io` (public) if it doesn't exist
...
gh repo create KarthikBalakumaran/karthikbalakumaran.github.io --public --source=. --remote=userpage --push
